...
const reliabilityIssueCopy: Record<Locale, Record<string, string>> = {
  ...
  ar: {
    ...
    "Logo erases more of the code than error correction can rebuild":
      "الشعار يمسح من الرمز أكثر مما يستطيع تصحيح الأخطاء إصلاحه",
    "Shrink the logo, cut its padding, or switch the plate to a circle":
      "صغّر الشعار، أو قلّل هامشه، أو اجعل اللوحة دائرية",
    "Logo sits directly on the modules": "الشعار ملتصق بوحدات الرمز مباشرة",
    "Turn the backing plate on, or add an outline, to keep the artwork separate":
      "أظهر لوحة الخلفية أو أضف إطارًا ليبقى الشعار منفصلًا عن الوحدات",
    "Decorative modules slow a camera down": "الأشكال الزخرفية تبطئ قراءة الكاميرا",
    "Square or rounded modules read fastest": "الوحدات المربعة أو الناعمة هي الأسرع قراءة",
    "Corner style distorts the finder patterns": "شكل الزوايا يشوّه مربعات التموضع",
    "Square, rounded or thick corners let a scanner lock on immediately":
      "الزوايا المربعة أو المستديرة أو السميكة تجعل الماسح يتعرف على الرمز فورًا",
    "Very dense grid; the camera has to get close": "الشبكة كثيفة جدًا وتحتاج الكاميرا أن تقترب",
    "Dense grid slows the first read": "كثافة الشبكة تبطئ القراءة الأولى",
    "Shorten the content — a short link keeps the grid coarse and reads instantly":
      "اختصر المحتوى؛ الرابط القصير يبقي الشبكة واسعة فتُقرأ فورًا",
...
const translations = {
  en: {
    ...
    layout: {
      ...
      tagline: "Press room · est. local browser",
      switchShift: "Switch shift",
      dayShift: "Day shift",
      nightShift: "Night shift",
      colophon: "Set in Bricolage Grotesque & IBM Plex. Printed locally, nothing leaves this machine.",
    },
    home: {
      generator: "Generator",
      qrCode: "QR Code",
      ...
      loadTicket: "Open ticket",
      copyLink: "Copy link",
      linkCopied: "Link copied",
      linkDropsLogo: "The link carries every setting except the logo image.",
      ticketLoaded: "Ticket loaded",
      ticketInvalid: "That file is not a job ticket",
      ...
      sheetTooSmall: "Nothing fits — reduce the code size or the margins",
      sheetDone: "Print sheet exported",
      tooLongTitle: "Content will not fit",
      tooLongBody: "This payload is {bytes} bytes, past what a QR code can hold. Shorten it, or use a short link.",
      verifying: "Checking…",
      verified: "Scan verified",
      verifiedHint: "Decoded back and matched the payload exactly.",
      verifyMismatch: "Decoded, but the content differs",
      verifyUnreadable: "Could not be decoded",
      verifyUnreadableHint: "Raise contrast, shrink the logo, or use a simpler module shape.",
      verifyUnsupported: "This browser cannot verify scans",
      recheck: "Re-check",
    },
    auth: {
      signIn: "Sign in",
      ...
      loginTitle: "Sign in",
      loginSubtitle: "Your designs, tickets and batches, on every device.",
      registerTitle: "Create an account",
      registerSubtitle: "One account keeps your work with you.",
      name: "Name",
      ...
      passwordHint: "4 characters or more.",
    ...
    projects: {
      ...
      accountSubtitle: "Your account and every design saved to it.",
      memberSince: "Member since",
      newProject: "New project",
      saveCurrent: "Save the current design",
      projectName: "Project name",
      namePlaceholder: "Restaurant menu",
      localWorkName: "Local design",
      empty: "No projects yet.",
      emptyHint: "Design something in the studio, then save it here as a project.",
      open: "Open",
      rename: "Rename",
      remove: "Delete",
      save: "Save",
      cancel: "Cancel",
      removeConfirm: "Delete this project permanently?",
      saving: "Saving…",
      savedJustNow: "Saved",
      ...
      withLogo: "With logo",
      signInToSave: "Sign in to keep your designs on every device.",
      conflictTitle: "This project changed on another device",
      conflictHint: "Nothing was overwritten. Choose which version stays.",
      keepMine: "Keep mine",
      takeTheirs: "Take the other one",
      syncCreated: "Your current design was saved as a new project.",
      unsavedTitle: "You have an unsaved design",
      unsavedHint: "It is safe on this device. Give it a name to keep it on your account.",
      syncUpdated: "Your edits were synced.",
      syncOffline: "Could not reach the server. Your design is safe on this device.",
      loading: "Loading…",
    ...
    qrControls: {
      ...
      logoShape: "Logo Cut",
      logoShapeHint: "“As is” keeps the whole picture. The other cuts crop it to fill the shape.",
      logoPlate: "Backing Plate",
      logoPlateOn: "Plate on",
      logoPlateOff: "Plate off",
      logoPlateColor: "Plate",
      logoPlateMatchSheet: "Match sheet",
      logoBorderColor: "Outline",
      logoRadius: "Corner Radius",
      logoPadding: "Padding",
      logoBorder: "Outline Width",
      gridDensity: "Grid",
      logoCoverage: "Logo covers",
      tuneForSpeed: "Tune for fast scanning",
      alreadyTuned: "Already tuned for fast scanning",
      errorCorrectionShort: "Error correction",
      noIssues: "No issues found. Your QR code should scan reliably.",
      reliabilityScore: "Reliability score",
      errorCorrectionLocked: "Locked to H while a logo covers the centre.",
      quietZone: "Quiet zone",
      quietZoneHint: "Blank margin around the code, in modules. Four is the standard.",
  ...
  ar: {
    ...
    layout: {
      ...
      tagline: "غرفة المطبعة · تعمل داخل متصفحك",
      switchShift: "تبديل الوردية",
      dayShift: "الوردية النهارية",
      nightShift: "الوردية الليلية",
      colophon: "بخطوط Bricolage Grotesque و IBM Plex. كل شيء يُطبع محلياً ولا يغادر جهازك.",
    },
    home: {
      generator: "المولّد",
      qrCode: "رمز QR",
      ...
      undo: "تراجع",
      redo: "إعادة",
      jobTicket: "بطاقة الشغل",
      saveTicket: "احفظ البطاقة",
      loadTicket: "افتح بطاقة",
      copyLink: "انسخ الرابط",
      linkCopied: "تم نسخ الرابط",
      linkDropsLogo: "الرابط يحمل كل الإعدادات ما عدا صورة الشعار.",
      ticketLoaded: "تم فتح البطاقة",
      ticketInvalid: "هذا الملف ليس بطاقة شغل",
      printSheet: "ورقة طباعة",
      pageSize: "مقاس الورقة",
      codeSize: "مقاس الرمز",
      gutter: "المسافة بين الرموز",
      margin: "هامش الورقة",
      cropMarks: "علامات القص",
      perPage: "في الصفحة",
      exportSheet: "صدّر الورقة",
      sheetTooSmall: "لا شيء يتسع — قلّل مقاس الرمز أو الهوامش",
      sheetDone: "تم تصدير ورقة الطباعة",
      tooLongTitle: "المحتوى لن يتسع",
      tooLongBody: "حجم المحتوى {bytes} بايت، وهو أكبر مما يستوعبه رمز QR. اختصره أو استخدم رابطاً قصيراً.",
      verifying: "جارٍ الفحص…",
      verified: "تم التحقق من المسح",
      verifiedHint: "قُرئ الرمز فعلياً وطابق المحتوى تماماً.",
      verifyMismatch: "تمت قراءته لكن المحتوى مختلف",
      verifyUnreadable: "تعذرت قراءته",
      verifyUnreadableHint: "ارفع التباين، أو صغّر الشعار، أو استخدم شكل وحدات أبسط.",
      verifyUnsupported: "هذا المتصفح لا يدعم التحقق",
      recheck: "أعد الفحص",
    },
    auth: {
      signIn: "تسجيل الدخول",
      ...
      loginSubtitle: "تصاميمك وبطاقات الشغل والدفعات، على كل أجهزتك.",
      registerTitle: "إنشاء حساب",
      registerSubtitle: "حساب واحد يبقي شغلك معك.",
      name: "الاسم",
      namePlaceholder: "اسمك",
      email: "البريد الإلكتروني",
      emailPlaceholder: "you@example.com",
      password: "كلمة المرور",
      passwordPlaceholder: "4 خانات على الأقل",
      passwordHint: "4 خانات فأكثر.",
      ...
      errorOffline: "تعذّر الوصول إلى الخادم. تحقق من اتصالك.",
      errorGeneric: "حدث خطأ. حاول مرة أخرى.",
      errorTooMany: "محاولات كثيرة. انتظر دقيقة ثم أعد المحاولة.",
      backToStudio: "العودة إلى الاستوديو",
    },
    projects: {
      title: "المشاريع",
      accountTitle: "ملفي",
      accountSubtitle: "حسابك وكل تصميم محفوظ فيه.",
      memberSince: "عضو منذ",
      newProject: "مشروع جديد",
      saveCurrent: "احفظ التصميم الحالي",
      projectName: "اسم المشروع",
      namePlaceholder: "قائمة المطعم",
      localWorkName: "تصميم محلي",
      empty: "لا توجد مشاريع بعد.",
      emptyHint: "صمّم شيئًا في الاستوديو ثم احفظه هنا كمشروع.",
      open: "فتح",
      rename: "إعادة تسمية",
      remove: "حذف",
      save: "حفظ",
      cancel: "إلغاء",
      removeConfirm: "حذف هذا المشروع نهائيًا؟",
      saving: "جارٍ الحفظ…",
      savedJustNow: "محفوظ",
      activeProject: "المشروع المفتوح",
      closeProject: "إغلاق المشروع",
      lastEdited: "آخر تعديل",
      withLogo: "فيه شعار",
      signInToSave: "سجّل الدخول لتبقى تصاميمك على كل أجهزتك.",
      conflictTitle: "تم تعديل هذا المشروع من جهاز آخر",
      conflictHint: "لم يُدهس شيء. اختر أي نسخة تبقى.",
      keepMine: "أبقِ نسختي",
      takeTheirs: "خذ النسخة الأخرى",
      syncCreated: "حُفظ تصميمك الحالي كمشروع جديد.",
      unsavedTitle: "عندك تصميم غير محفوظ",
      unsavedHint: "هو محفوظ على هذا الجهاز. سمِّه ليُحفظ في حسابك.",
      syncUpdated: "تمت مزامنة تعديلاتك.",
      syncOffline: "تعذّر الوصول إلى الخادم. تصميمك محفوظ على هذا الجهاز.",
      loading: "جارٍ التحميل…",
      openFailed: "تعذّر فتح المشروع.",
    ...
    qrControls: {
      ...
      logoShape: "قصّ الشعار",
      logoShapeHint: "«كما هو» يبقي الصورة كاملة، وبقية الأشكال تقصّها لتملأ الشكل.",
      logoPlate: "لوحة الخلفية",
      logoPlateOn: "اللوحة ظاهرة",
      logoPlateOff: "اللوحة مخفية",
      logoPlateColor: "لون اللوحة",
      logoPlateMatchSheet: "بلون الورقة",
      logoBorderColor: "لون الإطار",
      logoRadius: "استدارة الحواف",
      logoPadding: "الهامش الداخلي",
      logoBorder: "سماكة الإطار",
      gridDensity: "كثافة الشبكة",
      logoCoverage: "تغطية الشعار",
      tuneForSpeed: "اضبطه للقراءة السريعة",
      alreadyTuned: "مضبوط للقراءة السريعة",
      errorCorrectionShort: "تصحيح الأخطاء",
      noIssues: "لا توجد ملاحظات. يفترض أن يتم مسح رمز QR بثبات.",
      reliabilityScore: "درجة الموثوقية",
      errorCorrectionLocked: "مثبّت على H ما دام الشعار يغطي المنتصف.",
      quietZone: "الهامش الآمن",
      quietZoneHint: "مساحة فارغة حول الرمز بوحدات الموديول. المعيار أربع.",
